    ...
    <div name="home" className="h-screen w-full bg-[#0a192f]">
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
        <div className="flex flex-col justify-center h-full">
          ...
          <p className="text-gray-500 py-4 max-w-md">Hello! I'm Sagar Ingle, an aspiring React web developer with a strong passion for creating dynamic and user-friendly web applications. I have a Two years of experience as a Frontend Developer, I'm eager to learn and dedicated to building a career in front-end development.</p>
          <div>
